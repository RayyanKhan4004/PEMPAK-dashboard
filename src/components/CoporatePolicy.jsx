    ...
    <div>
      <div className="bg-orange-50 px-[120px] py-[100px]">
        ...
        <section className="bg-orange-50 py-12 px-4">
          <div className="max-w-6xl mx-auto grid grid-cols-3 gap-6 items-start relative">
            {/* Left Content */}
            <div className="space-y-4 text-right pr-6"></div>

            {/* Vertical Icons in Center */}
            <div className="flex flex-col items-center space-y-20 relative">
              <Image src="/others/Line-2.svg" alt="" className="top-0" width={32} height={200} />

              <div>
                <Image src="/coperate/coperate-1.svg" alt="" width={64} height={64} />
              </div>
            </div>
            ...
            <div className="space-y-4 pl-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                <strong>TRAINING</strong>, <strong>MOTIVATION</strong>, and a{" "}
                <strong>HEALTHY/SAFE</strong> work environment.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-3 gap-6 items-start relative">
            ...
            <div className="space-y-4 text-right pr-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                customer base and reducing marketing costs.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center space-y-20 relative">
              <div>
                <Image src="/others/Line-1.svg" alt="" width={32} height={200} />
              </div>
              <div>
                <div></div>
                <Image src="/coperate/coperate-2.svg" alt="" width={64} height={64} />
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-3 gap-6 items-start relative">
            ...
            <div className="flex flex-col items-center space-y-20 relative">
              ...
              <div>
                <div></div>
                <Image src="/coperate/coperate-3.svg" alt="" width={64} height={64} />
              </div>
            </div>
            ...
            <div className="space-y-4 pl-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                recognize the importance of ensuring that staff are adequately
                trained, informed and supervised to realize their activities in
                a safe manner.
              </p>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-3 gap-6 items-start relative">
            ...
            <div className="space-y-4 text-right pr-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                resources. Continuous improvement of the business is facilitated
                through constantly monitoring the satisfaction level of our
            ...
            <div className="flex flex-col items-center space-y-20 relative">
              ...
              <div>
                <div></div>
                <Image src="/coperate/coperate-4.svg" alt="" width={64} height={64} />
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-3 gap-6 items-start relative">
            ...
            <div className="flex flex-col items-center space-y-20 relative">
              ...
              <div>
                <div></div>
                <Image src="/coperate/coperate-5.svg" alt="" width={64} height={64} />
              </div>
            </div>
            ...
            <div className="space-y-4 pl-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                provide hygienic water to the natives with Millions of Rupees
                investment are the major projects undertaken by us. The primary
                education plan for young children is also under implementation.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-3 gap-6 items-start relative">
            ...
            <div className="flex flex-col items-center space-y-20 relative">
              ...
              <div>
                <div></div>
                <Image src="/coperate/coperate-6.svg" alt="" width={64} height={64} />
              </div>
            </div>
