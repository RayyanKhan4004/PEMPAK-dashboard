...
export const Navbar = () => {
  ...
  PEMPAK
      ...
      <div className="flex space-x-6 text-lg font-medium items-center">
        <Link href="/home" className="hover:text-amber-600 transition-colors">Home</Link>
        ...
        <Link href="/our-team" className="hover:text-amber-600 transition-colors">Our Team</Link>
