     ...
     <section className="container w-7xl mx-auto mt-15 ">
           ...
           <div className="grid grid-cols-2">
              ...
              <div className="space-y-4">
                    <Typography variant="h1" weight="b" color="dark font-medium"> Shahid Ali Malik</Typography> <br />
                    <Typography variant="h3" weight="semi-b" color="primary">Chief Executive Officer (CEO)</Typography>
                 ...
                 <Typography variant="h3" weight="semi-b" color="dark font-medium"> Experience</Typography> <br />
